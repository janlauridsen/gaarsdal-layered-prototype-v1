...
Dette dokument definerer det **faglige domæne, de etiske rammer
og de ufravigelige grænser** for `gaarsdal-layered-prototype-v1`.

Dokumentet er **normativt**.

Hvis AI-adfærd, orkestrering, UI eller senere implementeringer
...
## 2. Domænets omfang: Hypnoterapi som fag
...
## 3. Typiske anvendelsesområder i domænet
...
## 5. Systemets operative begrænsninger
...
## 6. Invariante regler (ufravigelige)

Følgende regler gælder altid:

1. Manglende information ⇒ konservativ beslutning
2. Sårbarhed ⇒ stop eller streng afgrænsning
3. Hypnotisk intervention kræver eksplicit domænemæssig tilladelse
4. Traumer og PTSD ⇒ ingen intervention
...
Dette dokument fastlægger hypnoterapi
